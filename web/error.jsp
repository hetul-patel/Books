...
<head>
    ...
    <style>
        ...
        .background-color {
            background-color: rgba(120, 230, 201, 1) !important;
        }
        ...
        .secondary-text-color {
            color: rgba(61, 56, 87, 1) !important;
        }
...
<div class="content-container">
    ...
    <div class="buttons-container">
        <a class="border-button" href="http://localhost:9898/index.jsp">Go To Homepage</a>
        <a class="border-button" href="mailto:hvp.sci@gmail.com" target="_blank">Report A Problem</a>
    </div>
</div>
